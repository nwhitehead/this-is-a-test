  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_number() {
        ...
        var result2 = result1 !== null
          ? (function(chars) { return parseInt(chars.join('')); })(result1)
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_sexprws() {
        var cacheKey = 'sexprws@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var result2 = result1 !== null
          ? (function(expr) { return expr; })(result1[0])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_sexpr() {
        ...
        var result22 = parse_number();
        if (result22 !== null) {
          var result0 = result22;
        } else {
          var result21 = parse_atom();
          if (result21 !== null) {
            var result0 = result21;
          } else {
            var result20 = parse_integer();
            if (result20 !== null) {
              ...
              if (result15 !== null) {
                ...
                var result11 = result10 !== null
                  ? (function(inner) { return [inner]; })(result10[1])
                  : null;
                if (result11 !== null) {
                ...
                if (result9 !== null) {
                  ...
                  var result3 = result2 !== null
                    ? (function(items, last) { items.push(last); return items; })(result2[1], result2[2])
                    : null;
                  if (result3 !== null) {
                    var result1 = result3;
                  } else {
